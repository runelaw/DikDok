...
export default function PledgeDocument({ but }) {
  ...
  return (
    <>
      <div
        className={`${
          but === 1 ? 'hidden' : 'visible'
        } flex flex-row items-center font-inter text-sm md:px-6 px-4 py-2 rounded-sm border border-solid border-black hover:cursor-pointer`}
        onClick={onOpen}
      >
      ...
      <div
        href="#_"
        className={`font-inter md:text-base px-4 md:px-10 py-3 rounded-sm bg-black text-white hover:cursor-pointer ${
